...
- ریسک اصلی محدودشدن همان اکانت اینستاگرام است، چون ربات هر ۱۵ دقیقه با نشست او درخواست می‌فرستد. گذاشتن پروکسی آی‌پی سرور را می‌پوشاند ولی cookie را نه؛ پس اگر اکانت اخطار گرفت، `proxies: false` بگذار و فاصله را بیشتر کن (cron را مثلاً `*/60` کن).

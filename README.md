...
سرورهای گیت‌هاب اکشنز در آی‌پی دیتاسنتر هستند و اینستاگرام به آن‌ها کد `۴۲۹` می‌دهد. با پروب روی خودِ runner (فایل‌های `probe_api.py` و `probe_matrix.py` و `probe_web.py`، اجرا از تب Actions) دقیقاً مشخص شد کدام در باز است و کدام بسته:
